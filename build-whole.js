...
const outputFile = path.join(docsDir, 'whole-ethical-christian.md');
const outputTitle = 'Ethical Christian (Complete)';
...
const outputSlug = '/whole-ethical-christian';
const publicSiteBase = 'https://ctzurcanu.github.io/ethical-christian';
const rawStaticBase =
    'https://raw.githubusercontent.com/ctzurcanu/ethical-christian/refs/heads/main/static/';
...
function loadCategoryMetadata(directory) {
    ...
    return {
        sidebarPosition: typeof metadata.position === 'number' ? metadata.position : undefined,
