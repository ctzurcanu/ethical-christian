...
This document compares the thirty steps in John Climacus's *Ladder of Divine Ascent* with the [21-axis virtue system](/whole-virtues). It tests coverage in both directions:
...
- The target definitions, ranges, and hierarchy are those in [On Virtues (Complete)](/whole-virtues).
